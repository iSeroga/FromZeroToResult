...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    next.addEventListener('click', () => {
        if(offset == deleteNotDigits(width) *(slides.length -1)){// '500px' (допускаєм)
            offset = 0;
        }else{
...
/* harmony import */ var _modules_serverForms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/serverForms */ "./js/modules/serverForms.js");
...
window.addEventListener('DOMContentLoaded', () =>{
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-11-7');
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_modules_serverForms__WEBPACK_IMPORTED_MODULE_4__["default"])('form', modalTimerId);
