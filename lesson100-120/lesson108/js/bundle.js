...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(src, alt, title, description, price, parentSelector) {
      ...
      // Створюємо порядок данний REST operator ...rest
      this.src = src;
      this.alt = alt;
      this.title = title;
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_6__.getResource)('http://localhost:3000/menu').then(function (data) {
    data.forEach(function (_ref) {
      var img = _ref.img,
        ...
        descr = _ref.descr,
        price = _ref.price;
      //  Натомість obj  Ми звертаємось до {} і наповнюємо його інфою ДЕструктизація
...
function serverForms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries())); //new way to say the same information that we have below
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_8__.postData)('http://localhost:3000/requests', json).then(function (data) {
        ...
        // бажано використовувати в кожному проєкті для 
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (serverForms);
...
function slider(_ref) {
  ...
  var indicators = document.createElement('ol'),
    dots = [];
  indicators.classList.add('carousel-indicators'); // Стилі додані в в ХТМЛ
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  function hideTabContent() {
    tabsContent.forEach(function (item) {
      // Аргумент називати як хочеш Item == pet or closerd
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'core-js/modules/es.symbol.to-string-tag.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'core-js/modules/es.math.to-string-tag.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var isCallable = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../internals/is-callable'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var isConstructor = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../internals/is-constructor'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var tryToString = __webpack_require__(/*! ../internals/try-to-string */ "../../../../node_modules/core-js/internals/try-to-string.js");
...
var isObject = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../internals/is-object'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var lengthOfArrayLike = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../internals/length-of-array-like'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var isArray = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../internals/is-array'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var isConstructor = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../internals/is-constructor'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var isObject = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../internals/is-object'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var wellKnownSymbol = __webpack_require__(/*! ../internals/well-known-symbol */ "../../../../node_modules/core-js/internals/well-known-symbol.js");
...
var isCallable = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../internals/is-callable'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var definePropertyModule = __webpack_require__(/*! ../internals/object-define-property */ "../../../../node_modules/core-js/internals/object-define-property.js");
var makeBuiltIn = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../internals/make-built-in'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var isForced = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../internals/is-forced'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../modules/es.regexp.exec'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var uncurryThis = __webpack_require__(/*! ../internals/function-uncurry-this */ "../../../../node_modules/core-js/internals/function-uncurry-this.js");
var defineBuiltIn = __webpack_require__(/*! ../internals/define-built-in */ "../../../../node_modules/core-js/internals/define-built-in.js");
...
/* harmony import */ var _modules_serverForms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/serverForms */ "./js/modules/serverForms.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('.modal', modalTimerId);
  }, 300000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022-11-7');
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_modules_serverForms__WEBPACK_IMPORTED_MODULE_5__["default"])('form', modalTimerId);
